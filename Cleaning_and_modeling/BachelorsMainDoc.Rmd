...
ggsave("tfidfNoNames.png", width = 12, height = 5)
...
ggsave("tfidfNames.png", width = 12, height = 5)
```
...
```{r}
save.image("/home/ptrt/BachelorsProjectCOVID19NLP/modelingWorkspace.RData")
